...
* Returns r.
**************************************************/
MLD_HD int32_t PQCLEAN_MLDSA87_CLEAN_montgomery_reduce(int64_t a) {
    int32_t t;
...
* Returns r.
**************************************************/
MLD_HD int32_t PQCLEAN_MLDSA87_CLEAN_reduce32(int32_t a) {
    int32_t t;
...
* Returns r.
**************************************************/
MLD_HD int32_t PQCLEAN_MLDSA87_CLEAN_caddq(int32_t a) {
    a += (a >> 31) & Q;
    return a;
}
...
* Returns r.
**************************************************/
MLD_HD int32_t PQCLEAN_MLDSA87_CLEAN_freeze(int32_t a) {
